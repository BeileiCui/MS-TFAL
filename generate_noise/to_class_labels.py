...
def to_class_label(mode = 'train'):
    ...
    MY_DATA_ROOT = './dataset/endovis18/'
    ...
    for ins in train:         
        save_dir = os.path.join(MY_DATA_ROOT, 'train/seq_'+str(ins) + '/class_labels')
        if not os.path.exists(save_dir):
            os.mkdir(save_dir)
    # for ins in test:         
    #     save_dir = os.path.join(MY_DATA_ROOT, 'test/seq_'+str(ins) + '/class_labels')
    #     if not os.path.exists(save_dir):
    #         os.mkdir(save_dir)

    if mode == 'train':
        r_lb = os.path.join(MY_DATA_ROOT, 'train/seq_{}/labels/frame{:03d}.png') 
        sav_pt = os.path.join(MY_DATA_ROOT, 'train/seq_{}/class_labels/frame{:03d}.png')
    # elif mode == 'test':
    #     r_lb = os.path.join(MY_DATA_ROOT, 'test/seq_{}/labels/frame{:03d}.png') 
    #     sav_pt = os.path.join(MY_DATA_ROOT, 'test/seq_{}/class_labels/frame{:03d}.png')
