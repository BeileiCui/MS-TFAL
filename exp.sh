...
python test.py --arch swinPlus --log_name STswin_clean_ver_0 --t 4 --gpu 0 --checkpoint 3 --h 256 --w 320
python test.py --dataset colon_oct --arch swinPlus --log_name STswin_oct_ver_0 --root_dir ./results/colon_oct --t 4 --gpu 0 --checkpoint 4 --h 256 --w 256
...
python test.py --arch RAUNet --log_name RAUNet_clean_ver_0 --t 1 --gpu 0 --checkpoint 4 --h 256 --w 320
python test.py --dataset colon_oct --arch RAUNet --log_name RAUNet_oct_ver_0 --root_dir ./results/colon_oct --t 1 --gpu 0 --checkpoint 3 --h 256 --w 256
...
python train_MSS_TFAL.py --dataset colon_oct --arch puredeeplab18 --log_name MSS_TFAL_oct --root_dir ./results/colon_oct --t 1 --batch_size 4 --lr 1e-4 --gpu 0,3 --ver 2 --iterations 64000  --h 256 --w 256 --T1 2 --T2 3 --T3 4

python test.py --arch puredeeplab18 --log_name MSS_TFAL_noisyver_3_ver_0 --t 1 --gpu 0 --checkpoint 31 --h 256 --w 320
python test.py --dataset colon_oct --arch puredeeplab18 --log_name MSS_TFAL_oct_ver_0 --root_dir ./results/colon_oct --t 1 --gpu 0 --checkpoint 24 --h 256 --w 256
